          ...
          <div className="bg-[var(--color-cream)] rounded-2xl p-8 flex gap-6 items-start animate-fade-up">
            ...
            <div>
              ...
              <p className="text-[var(--color-muted)] leading-relaxed">
                Licensed clinical psychologists and a board-certified psychiatric nurse practitioner, dedicated to delivering evidence-based neuropsychological assessment and rehabilitation services in Fredericksburg, VA.
              </p>
            </div>
          </div>
        </div>
