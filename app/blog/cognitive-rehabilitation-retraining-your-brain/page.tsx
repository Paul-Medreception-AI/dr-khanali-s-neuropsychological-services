          ...
          <div className="bg-[var(--color-cream)] rounded-2xl p-8 flex gap-6 items-start">
            ...
            <div>
              ...
              <p className="text-[var(--color-muted)] text-sm leading-relaxed">
                Board-certified providers specializing in Mental Health, committed to delivering evidence-based neuropsychological assessment and cognitive rehabilitation services to the Fredericksburg, VA community.
              </p>
            </div>
          </div>
        </div>
