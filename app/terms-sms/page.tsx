      ...
      <section className="bg-gradient-to-br from-[var(--color-dark)] to-[var(--color-primary)] py-20 text-white text-center">
        <div className="container mx-auto px-6">
          <h1 className="font-cormorant text-5xl font-bold mb-4 animate-fade-up">
            Dr. Khanali&apos;s Neuropsychological Services Terms and Conditions - SMS
          </h1>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-[var(--color-muted)] mb-6">
              This messaging program sends appointment confirmation and reminder messages to customers who have booked an appointment with Dr. Khanali&apos;s Neuropsychological Services through our website at https://www.drkhanalineuropsychologicalservicesllc.com, or via our scheduling forms, and have explicitly opted in to receive SMS notifications. Opt-in is collected via web forms with a dedicated checkbox for SMS consent. Messages include scheduling confirmations, appointment reminders, rescheduling updates, and customer support communications.
            </p>
            ...
            <p className="text-[var(--color-muted)] mb-6">
              If you experience issues with the messaging program, reply with the keyword &quot;HELP&quot; for more assistance, or reach out directly to drkhanali@drkhanalineuropsychologicalservicesllc.com during business hours.
            </p>
            ...
            <p className="text-[var(--color-muted)] mb-6">
              For privacy-related inquiries, please refer to our <a href="/privacy-sms" className="text-[var(--color-primary)] underline">Privacy Policy</a> at https://www.drkhanalineuropsychologicalservicesllc.com/privacy-sms
            </p>
            <p className="text-[var(--color-muted)] mb-6">
            ...
            <p className="text-[var(--color-muted)] mb-6">
              This website (the &quot;Site&quot;) is owned and operated by Dr. Khanali&apos;s Neuropsychological Services (&quot;COMPANY,&quot; &quot;we&quot; or &quot;us&quot;). By using the Site, you agree to be bound by these Terms of Service and to use the Site in accordance with these Terms of Service, our Privacy Policy, and any additional terms and conditions that may apply to specific sections of the Site or to products and services available through the Site or from Dr. Khanali&apos;s Neuropsychological Services.
            </p>
            <p className="text-[var(--color-muted)] mb-6">
            ...
            <p className="text-[var(--color-muted)] mb-6">
              This Site and all the materials available on the Site are the property of Dr. Khanali&apos;s Neuropsychological Services and/or our affiliates or licensors and are protected by copyright, trademark, and other intellectual property laws. The Site is provided solely for your personal non-commercial use.
            </p>
            <p className="text-[var(--color-muted)] mb-6">
            ...
            <p className="text-[var(--color-muted)] mb-6">
              You agree at all times to indemnify and hold harmless Dr. Khanali&apos;s Neuropsychological Services, its affiliates, and their respective officers, directors, agents, and employees from any claims, causes of action, damages, liabilities, costs, and expenses arising out of or related to your breach of any obligation, warranty, or representation under these Terms of Service.
            </p>
            ...
            <p className="text-[var(--color-muted)] mb-6">
              Your participation in any dealings with third-party vendors is solely between you and the third party. Dr. Khanali&apos;s Neuropsychological Services shall not be responsible for any loss or damage incurred as a result of such dealings.
            </p>
            ...
            <p className="text-[var(--color-muted)] mb-6">
              If you suspect unauthorized use of your account, notify us immediately at drkhanali@drkhanalineuropsychologicalservicesllc.com. We are not liable for any loss or damage arising from your failure to comply with this obligation.
            </p>
            ...
            <p className="text-[var(--color-muted)] mb-6">
              These Terms of Service shall be governed by and construed in accordance with the laws of the State of VA. Any dispute arising under these Terms shall be resolved exclusively through binding arbitration in that jurisdiction.
            </p>
